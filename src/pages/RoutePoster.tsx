      ...
      <section className="w-full max-w-md mx-auto px-4 mt-2">
        ...
        >
          ...
          <div className="relative z-10 px-7 pt-8 pb-4 text-center">
            <p className="font-body text-[9px] tracking-[0.35em] uppercase" style={{ color: "rgba(255,255,255,0.35)" }}>
              Tonight's Route
            </p>
            <h2 className="font-display text-[32px] leading-[1.1] font-bold mt-2" style={{ color: "#fff" }}>
              {routeName}
            </h2>
                    ...
                    >
                      ...
                      <div className="flex-shrink-0">
                        ...
                        >
                          ...
                          <span className="font-body text-[8px] font-bold mt-0.5" style={{ color }}>
                      ...
                      <div className="flex-1 min-w-0 pt-1">
                        <p className="font-body text-[9px] font-semibold uppercase tracking-[0.15em]" style={{ color }}>
                          Stop {i + 1}
                        </p>
                        <h3 className="font-display text-[18px] font-bold leading-snug mt-0.5" style={{ color: "#fff" }}>
                          {stop.name}
                        </h3>
                        <p className="font-body text-[10px] leading-relaxed mt-1 line-clamp-2" style={{ color: "rgba(255,255,255,0.35)" }}>
                          {stop.description}
                        </p>
                      </div>
                    </div>
          ...
          <div className="relative z-10 text-center pb-7 pt-2">
            <div className="w-12 h-[1px] mx-auto mb-4" style={{ background: "linear-gradient(90deg, transparent, rgba(255,255,255,0.2), transparent)" }} />
            <p className="font-display text-lg font-bold" style={{ color: "#fff" }}>Veya</p>
            <p className="font-body text-[8px] tracking-[0.3em] uppercase mt-0.5" style={{ color: "rgba(255,255,255,0.25)" }}>
              Curated Evenings
            </p>
          </div>
        </div>
